...
python train.py --name exper4 --niter 200 --niter_decay 200 --lr_G 0.0002 --lr_D 0.0002 --batchSize 2 --patch_size 64 128 128 --threshold_black_voxels 0.5 --model unpaired_revgan3d --which_model_netG vnet_generator  --which_model_netD n_layers --n_layers_D 3 --dataset_mode npy_unaligned_3d --dataroot /hpcwork/ft002207/lung1_lidc_gan --gpu_ids 0,1 --save_epoch_freq 25 --nThreads 8 --wandb True
