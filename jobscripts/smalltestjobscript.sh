...
python train.py --name smalltest --batchSize 4 --nThread 4 --niter 20 --niter_decay 20 --lr_G 0.0002 --lr_D 0.0002 --model unpaired_revgan3d --which_model_netG revResVnet_generator_3d  --which_model_netD n_layers --n_layers_D 3 --dataset_mode npy_unaligned_3d --dataroot /hpcwork/ft002207/lung1_lidc_gan --gpu_ids 0,1 --save_epoch_freq 10
