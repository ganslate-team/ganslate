...
python train.py --name stol4 --niter 500 --niter_decay 500 --lr_G 0.0001 --lr_D 0.0004 --batch_size 8  --patch_size 64 64 64 --model unpaired_revgan3d --which_model_netG big_vnet_generator  --which_model_netD n_layers --n_layers_D 3 --dataset_mode npy_unaligned_3d --dataroot /hpcwork/ft002207/ASensation16_BLightSpeed16/ --gpu_ids 0,1 --save_epoch_freq 25 --num_workers 8 --wandb True