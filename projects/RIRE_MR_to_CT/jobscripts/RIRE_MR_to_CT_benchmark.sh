...
### Job name
#SBATCH --job-name=RIRE_MR_to_CT_benchmark
...
CUDA_VISIBLE_DEVICES=0 python tools/train.py config=projects/RIRE_MR_to_CT/experiments/RIRE_MR_to_CT_benchmark.yaml