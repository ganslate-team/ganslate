...
### Job name
#SBATCH --job-name=RIRE_MR_to_CT_p000s_PiCycle
...
conda activate gan_env_git
### Run training
cd $HOME/midaGAN/
CUDA_VISIBLE_DEVICES=0 python tools/train.py config=projects/RIRE_MR_to_CT/experiments/RIRE_MR_to_CT_p000s_PiCycle.yaml