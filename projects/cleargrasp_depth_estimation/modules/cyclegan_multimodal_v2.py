...
from projects.cleargrasp_depth_estimation.modules.custom_cyclegan_losses import CustomCycleGANLosses
...
@dataclass
class CycleGANMultiModalV2Config(configs.base.BaseGANConfig):
...
class CycleGANMultiModalV2(BaseGAN):
    """CycleGAN architecture for multimodal images -- Version 2"""
    ...
    def __init__(self, conf):
        ...
        loss_names = [
            'D_A', 'G_A', 'cycle_A', 'idt_A', 'inv_A', 'comp_sim_A', 'D_B', 'G_B', 'cycle_B', 'idt_B', 'inv_B', 'comp_sim_B'
        ]
    ...
    def backward_G(self):
        ...
        # ------------- G Losses (Cycle, Identity, Component) -------------
