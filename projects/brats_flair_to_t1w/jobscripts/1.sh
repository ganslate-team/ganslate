...
python -m torch.distributed.launch --nproc_per_node 2 trainer.py config=projects/brats_flair_to_t1w/experiment1.yaml mixed_precision=True logging.wandb=True logging.log_freq=50
