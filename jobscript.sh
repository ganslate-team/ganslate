...
python3 train.py --niter 100 --niter_decay 100 --dataset_mode npy_aligned_3d --dataroot ../patchified/ --model paired_revgan3d --name 3d_460 --which_model_netG srcnn_generator_3d --gpu_ids 0,1 --loadSize 256 --fineSize 256 --batchSize 2
