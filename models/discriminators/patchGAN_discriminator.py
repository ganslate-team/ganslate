...
class PatchGANDiscriminator(nn.Module):
    def __init__(self, n_channels_input, start_n_filters, n_layers, norm_type, **shit): # TODO: remove shit
        super(PatchGANDiscriminator, self).__init__()
        # TODO: these two here or in define_D?
        ...
        padw = 1
        sequence = [
            nn.Conv3d(n_channels_input, start_n_filters, kernel_size=kw, stride=2, padding=padw),
