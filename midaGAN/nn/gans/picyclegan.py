...
class PiCycleGAN(BaseGAN):
    ...
    def __init__(self, conf):
        ...
        self.setup() # schedulers, checkpoint loading and network parallelization
    ...
    def optimize_parameters(self):
        ...
        # -----------------------------------------------------------------------------------------
        self.scaler.update()  # update loss scale factor, necessary for mixed precision
    ...
    def forward(self):
        ...
        with autocast(enabled=self.conf.mixed_precision):
    ...
    def backward_D(self):
        """Calculate GAN loss for the discriminators and perform backward on it."""
        for discriminator in ['D_A', 'D_B']:
            ...
            # backprop
            self.backward(loss=self.losses[discriminator], retain_graph=True)
    ...
    def backward_G(self):
        ...
        self.backward(loss=combined_loss_G)
