...
class ResnetGenerator(nn.Module):
    ...
    def __init__(self, norm_type, ngf=64, use_dropout=False, n_blocks=6, padding_type='reflect', no_antialias=False, no_antialias_up=False):
...
class ResnetDecoder(nn.Module):
    ...
    def __init__(self, input_nc, output_nc, norm_type, ngf=64, use_dropout=False, n_blocks=6, padding_type='reflect', no_antialias=False):
