...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--start_n_filters_G', type=int, default=64, help='# of gen filters in first conv layer')
        parser.add_argument('--start_n_filters_D', type=int, default=64, help='# of discrim filters in first conv layer')
