...
class BaseOptions():
    ...
    def initialize(self, parser):
        parser.add_argument('--dataset.root', required=True, help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        parser.add_argument('--batch_size', type=int, default=1, help='input batch size')
        parser.add_argument('--load_size', type=int, default=286, help='scale images to this size')
        parser.add_argument('--fine_size', type=int, default=256, help='then crop to this size')
        parser.add_argument('--n_channels_input', type=int, default=1, help='# of input image channels')
        parser.add_argument('--n_downsampling', type=int, default=2, help='# downsampling layers')
        parser.add_argument('--n_channels_output', type=int, default=1, help='# of output image channels')
        parser.add_argument('--n_first_filters_G', type=int, default=64, help='# of gen filters in first conv layer')
        parser.add_argument('--n_first_filters_D', type=int, default=64, help='# of discrim filters in first conv layer')
        ...
        parser.add_argument('--weight_init_type', type=str, default='normal', help='network initialization [normal|xavier|kaiming|orthogonal]')
        parser.add_argument('--weight_init_gain', type=float, default=0.02, help='scaling factor for normal, xavier and orthogonal.')
